...
pub fn recipe() -> Recipe {
    ...
    let cfg = [
        ...
        // build != host keeps configure's cross_compiling=yes (glibc skips
        // run-tests). Prior builds let config.guess derive x86_64 from host
        // uname -m; pin it so the mesboot0 PATH needs no uname (re #469).
