...
/// ScreenCast, RemoteDesktop, Camera, Secret, and Print, their direct entry
/// methods return exact `UnknownMethod`, and live introspection omits them.
///
/// DUPLICATED as `UNAVAILABLE_READY_MARKER` in td-portal/src/main.rs and pinned
/// by the td-portal recipe.
pub const TD_PORTAL_UNAVAILABLE_RUNTIME_MARKER: &str =
