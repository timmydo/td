...
build-daemon:
	...
	scratch="$(CURDIR)/.build-daemon-scratch"; chmod -R u+w "$$scratch" 2>/dev/null || true; rm -rf "$$scratch"; mkdir -p "$$scratch"; \
	$(GUIX) repl $(LOAD) tests/daemon-drv.scm 2>"$$scratch/repl.err" > "$$scratch/facts.txt" \
