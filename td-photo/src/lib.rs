...
//! `develop` the demosaic, resampler and pipeline, and `image` the RGB
//! buffers and PPM writer. None of these reads a file, the environment, a
//! clock or a descriptor: `main` and, later, the library adapter own I/O.
