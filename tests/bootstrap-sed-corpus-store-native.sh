...
#
# The toolchain build is the brick-8 hello gate's verbatim; only the corpus package differs (hello → sed). The
# gate also re-checks the toolchain by linking + running a C and a C++ program → 42 before the sed build.
