...
# binutils-2.44 + cross gcc-14.3.0 + x86_64 glibc-2.41 + libgcc_s, built from the seed by
# gate rust-x86_64-runtime-store-native via tests/x86_64-cross-fns.sh, #201) a STABLE
