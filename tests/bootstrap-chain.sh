...
ladder_lock binutils-mesboot binutils-mesboot-source rung:make-mesboot0 rung:patch-mesboot rung:binutils-mesboot1 rung:gcc-mesboot1 rung:glibc-mesboot0 src:patch-binutils-boot-2.20.1a src:linux-headers tool:flex tool:bison $BT || fail "lock binutils-mesboot"
ladder_lock gawk-mesboot gawk-mesboot-source rung:make-mesboot0 rung:binutils-mesboot1 rung:gcc-mesboot1 rung:glibc-mesboot0 src:linux-headers $BT || fail "lock gawk-mesboot"
ladder_lock glibc-mesboot glibc-216-source rung:make-mesboot0 rung:patch-mesboot rung:binutils-mesboot rung:gcc-mesboot1 rung:glibc-mesboot0 rung:gawk-mesboot src:patch-glibc-boot-2.16.0 src:patch-glibc-bootstrap-system-2.16.0 src:linux-headers $BT || fail "lock glibc-mesboot"
...
ladder_lock glibc-mesboot-shared glibc-216-source rung:make-mesboot0 rung:patch-mesboot rung:binutils-mesboot rung:gcc-mesboot1 rung:glibc-mesboot0 rung:gawk-mesboot src:patch-glibc-boot-2.16.0 src:patch-glibc-bootstrap-system-2.16.0 src:linux-headers $BT || fail "lock glibc-mesboot-shared"
