...
- [ ] **ts-frontend** — claimed claude-fable-3ca5dd 2026-06-13 (Phase 1 of §5 move-off-Guile: TypeScript spec surface on a boa evaluator, lowering to the frozen oracle's drvs; charter landed #15, implementation started — sub-task 1 swc transpile; boa vendored as a pinned input per human 2026-06-13) — `plan/ts-frontend.md`
