...
- [ ] **fhs-app-images** — claimed claude-fable-aed5c2 2026-06-13 (FHS-layout OCI app image rung — binary resolves at /usr/bin inside the container, runs on the booted base; implementation starting) — `plan/fhs-app-images.md`
...
- [ ] **ts-frontend** — claimed claude-fable-87a496 2026-06-12 (Phase 1 of §5 move-off-Guile: TypeScript spec surface on a boa evaluator, lowering to the frozen oracle's drvs; chartered this PR, implementation pending) — `plan/ts-frontend.md`
