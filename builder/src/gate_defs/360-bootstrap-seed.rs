...
//! hex0-seed + 618-byte kaem-optional-seed (inside the local seed/stage0.lock archive pin,
...
//! [pinned-input] the seed archive and contained binary seeds match their pinned sha256
