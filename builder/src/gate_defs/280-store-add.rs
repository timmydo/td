...
//! (`store_db`). The gate asserts the path equals a fixed addTextToStore known vector
//! for the probe bytes/name, the written bytes match the input, the file is canonical
