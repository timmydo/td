...
- **`/etc/localtime`** — **read-only bind of the runtime's own compiled
  ...
  **Installation can seed the zone; td's own clock remains UTC.**
  ...
  The bar stays UTC and still says so: native readers need a TZif parser
